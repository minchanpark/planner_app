                    ...
                    children: [
                                    ...
                                    child: Consumer<AuthViewModel>(
                                      builder: (context, authViewModel, child) {
                                        return ListView.builder(
                                          itemCount: authViewModel
                                              .searchResults.length,
                                          itemBuilder: (context, index) {
                                            final nickName = authViewModel
                                                .searchResults[index];
                                            final profileImage = authViewModel
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          ...
                          List<String> mates =
                              List.from(categoryViewModel.selectedNames);
                          ...
                          try {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                                content:
                                    Text("카테고리 생성 중 오류가 발생했습니다. 다시 시도해주세요.")));
                          }
                        },
                        style: ElevatedButton.styleFrom(
                          backgroundColor:
