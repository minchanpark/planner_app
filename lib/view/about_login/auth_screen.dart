...
class _AuthScreenState extends State<AuthScreen> {
  ...
  void initState() {
    ...
    /*WidgetsBinding.instance.addPostFrameCallback((_) {
      widget.authViewModel = Provider.of<AuthViewModel>(context, listen: false);
    });*/
    ...
    return _buildScrollContainer(
      ...
      _buildInputPage(
        ...
        onNext: (value) {
          phoneNumber = value;
          // 실제 Auth 로직 호출
          widget.authViewModel.verifyPhoneNumber(
            phoneNumber,
    ...
    return _buildScrollContainer(
      ...
      _buildInputPage(
        ...
        onNext: (value) {
          smsCode = value;
          // 실제 Auth 로직 호출
          widget.authViewModel.signInWithSmsCode(
            smsCode,
            _goToNextPage,
          );
        },
